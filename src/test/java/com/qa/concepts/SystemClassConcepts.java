...
public class SystemClassConcepts {
    ...
    //System class is a final class and can't be instantiated
    //out is a static final variable under System class .Return type is PrintStream
    //println is a method under PrintStream class

    //write following js code in a console
    /*
    var x = ""
    for(i = 1;i<255;i++)
    {
